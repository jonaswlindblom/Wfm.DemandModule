...
const SAVED_RULES = [
    { id: 'r1', name: 'Regnboost F&B', prompt: 'Om regn > 5mm och besökare > 200, öka F&B-personal med 1.', status: 'aktiv', lastEdited: '2h sedan' },
    { id: 'r2', name: 'Lunchrusning', prompt: 'Starta förberedelseskiftet 1 timme tidigare om bokningar > 50.', status: 'aktiv', lastEdited: '1d sedan' },
    { id: 'r3', name: 'Säkerhetsnivå', prompt: 'Om kötid > 15m, öppna extra säkerhetslinje.', status: 'utkast', lastEdited: '3d sedan' },
];

const DATA_STREAMS = [
    { id: 'visitors', name: 'Besöksräknare', type: 'IoT Sensor', status: 'live', latency: '45ms', value: '432/h', health: 98, icon: Users },
    { id: 'sales', name: 'Kassatransaktioner', type: 'API', status: 'live', latency: '120ms', value: '24 kkr/h', health: 100, icon: ShoppingCart },
    { id: 'queue', name: 'Kötider', type: 'Kamera AI', status: 'fördröjd', latency: '5m', value: '12m snitt', health: 85, icon: Clock },
    { id: 'weather', name: 'Lokalt Väder', type: 'Extern API', status: 'live', latency: '1s', value: 'Regn 2mm', health: 100, icon: CloudSun },
    ...
    { id: 'staff', name: 'Stämplingar', type: 'WFM', status: 'live', latency: '30s', value: '18 Inne', health: 99, icon: Users },
...
// DAG-LÄGE (Timmar)
const HOURLY_DATA = [
    { label: '08:00', baseline: 12, ai_demand: 12, actual: 11, visitors: 120, sales: 12, variance: 'låg' },
    { label: '09:00', baseline: 15, ai_demand: 16, actual: 16, visitors: 200, sales: 18, variance: 'låg' },
    { label: '10:00', baseline: 22, ai_demand: 24, actual: 23, visitors: 350, sales: 25, variance: 'medel' },
    { label: '11:00', baseline: 30, ai_demand: 35, actual: 36, visitors: 580, sales: 40, variance: 'hög' },
    ...
    { label: '14:00', baseline: 30, ai_demand: 32, actual: null, visitors: 400, sales: 30, variance: 'låg' },
    { label: '15:00', baseline: 25, ai_demand: 24, actual: null, visitors: 300, sales: 22, variance: 'låg' },
    { label: '16:00', baseline: 25, ai_demand: 28, actual: null, visitors: 380, sales: 28, variance: 'medel' },
    { label: '17:00', baseline: 35, ai_demand: 40, actual: null, visitors: 600, sales: 45, variance: 'hög' },
    { label: '18:00', baseline: 40, ai_demand: 42, actual: null, visitors: 650, sales: 48, variance: 'låg' },
    { label: '19:00', baseline: 30, ai_demand: 30, actual: null, visitors: 400, sales: 35, variance: 'låg' },
] as const;

// VECKO-LÄGE (Dagar)
const DAILY_DATA = [
    { label: 'Mån', baseline: 320, ai_demand: 330, actual: 325, visitors: 4200, sales: 320, variance: 'låg' },
    { label: 'Tis', baseline: 310, ai_demand: 315, actual: 318, visitors: 4100, sales: 310, variance: 'låg' },
    { label: 'Ons', baseline: 340, ai_demand: 360, actual: null, visitors: 4800, sales: 350, variance: 'medel' },
    { label: 'Tors', baseline: 380, ai_demand: 410, actual: null, visitors: 5200, sales: 400, variance: 'hög' },
    { label: 'Fre', baseline: 450, ai_demand: 480, actual: null, visitors: 6500, sales: 550, variance: 'hög' },
    { label: 'Lör', baseline: 520, ai_demand: 510, actual: null, visitors: 7200, sales: 600, variance: 'låg' },
    { label: 'Sön', baseline: 400, ai_demand: 395, actual: null, visitors: 5500, sales: 420, variance: 'låg' },
] as const;

// MÅNADS-LÄGE (Veckor)
const WEEKLY_DATA = [
    { label: 'V.41', baseline: 2400, ai_demand: 2450, actual: 2440, visitors: 32000, sales: 2400, variance: 'låg' },
    { label: 'V.42', baseline: 2550, ai_demand: 2600, actual: 2580, visitors: 34000, sales: 2550, variance: 'låg' },
    { label: 'V.43', baseline: 2300, ai_demand: 2450, actual: null, visitors: 31000, sales: 2300, variance: 'hög' },
...
const SUGGESTIONS_MAP: Record<Period, Suggestion[]> = {
    day: [
        { id: 1, title: 'Öka F&B 12:00–14:00', reason: 'Publikökning pga regn.', impact: '+4.5h', confidence: 94, type: 'ökning' },
        { id: 2, title: 'Minska Städ Kväll', reason: 'Lågt besöksantal.', impact: '-2.0h', confidence: 88, type: 'minskning' },
        { id: 3, title: 'Öppna Säkerhetslinje', reason: 'Kötider > 10m.', impact: '+3.0h', confidence: 76, type: 'ökning' },
    ],
    week: [
        { id: 4, title: 'Helgbemanning Lördag', reason: 'Lokalt event ökar trycket.', impact: '+24h', confidence: 91, type: 'ökning' },
        { id: 5, title: 'Minska Tisdag Morgon', reason: 'Låg historisk trend.', impact: '-8.0h', confidence: 85, type: 'minskning' },
    ],
    month: [
        { id: 6, title: 'Höstlovsjustering V.44', reason: 'Skollov ökar besökare.', impact: '+120h', confidence: 89, type: 'ökning' },
        { id: 7, title: 'Optimera Schemaläggning', reason: 'Effektiviseringspotential V.42.', impact: '-40h', confidence: 82, type: 'minskning' },
    ]
};
...
const KPI_STRIP_BY_PERIOD: Record<Period, StripKpi[]> = {
    day: [
        ...
        { label: 'Högst Varians', value: '11:00', sub: '+5h', icon: TrendingUp, color: 'amber' },
        { label: 'AI Konfidens', value: '94%', sub: 'Hög', icon: Sparkles, color: 'purple' },
        { label: 'Risk', value: 'Låg', sub: '<2%', icon: ShieldAlert, color: 'emerald' },
    ...
    week: [
        ...
        { label: 'Högst Varians', value: 'Fredag', sub: '+12%', icon: TrendingUp, color: 'amber' },
    ...
    month: [
        ...
        { label: 'Högst Varians', value: 'V.43', sub: '-5%', icon: TrendingUp, color: 'amber' },
        { label: 'AI Konfidens', value: '92%', sub: 'Hög', icon: Sparkles, color: 'purple' },
        { label: 'Risk', value: 'Låg', sub: 'Stabil', icon: ShieldAlert, color: 'emerald' },
...
const Card: React.FC<{
    ...
    action?: React.ReactNode; // <-- viktig: gör optional
    noPadding?: boolean;
...
const ScreenRuleBuilder = () => {
    const [prompt, setPrompt] = useState("Om regn > 5mm och besökare > 200, öka F&B-personal med 1.");
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-full p-6">
            <div className="col-span-1 lg:col-span-5 flex flex-col gap-4 h-full">
                <Card title="Definiera Regel (Naturligt Språk)" className="flex-1">
                    <div className="flex flex-col h-full">
                        <p className="text-sm text-slate-500 mb-4">
                            Beskriv din logik på svenska. AI:n översätter det till systemregler.
                        </p>
                        <textarea
                            ...
                            placeholder="T.ex. Om försäljningen överstiger 50 000 kr..."
                        />
            ...
            <div className="col-span-1 lg:col-span-7 h-full">
                <Card title="Strukturerad Förhandsgranskning" className="h-full bg-slate-50/50" action={
                    generatedRule && <Badge color="green">Konfidens: 98%</Badge>
                }>
                    {!generatedRule ? (
                        <div className="h-full flex flex-col items-center justify-center text-slate-400">
                            <ArrowRightLeft className="w-10 h-10 mb-2 opacity-50" />
                            <p className="text-sm">Väntar på indata...</p>
                        </div>
                    ) : (
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-white p-3 rounded border border-slate-200">
                                    <div className="text-[10px] text-slate-400 uppercase font-bold mb-1">Datakällor</div>
                            ...
                            <div>
                                <div className="text-[10px] text-slate-400 uppercase font-bold mb-2">Påverkan</div>
    ...
    return (
        <div className="flex flex-col h-full gap-6 p-6 overflow-hidden">
                ...
                {DATA_STREAMS.slice(0, 5).map((s) => (
                    <div key={s.id} className="bg-white p-4 rounded-lg border border-slate-200 shadow-sm relative overflow-hidden">
                        ...
                        <div className="pl-2">
                            ...
                            <div className="text-[10px] text-slate-400 mt-1">{s.type} • {s.latency}</div>
                        </div>
                    </div>
                ))}
            </div>
            ...
            <div className="flex-1 min-h-0 flex gap-6">
                <Card title="Händelsetidslinje" className="flex-1" noPadding action={
                    <div className="flex items-center gap-2">
                        <span className="text-xs text-slate-500">Visa rådata</span>
                            ...
                            <table className="w-full text-left text-sm">
                                <thead className="bg-slate-50 border-b border-slate-200 sticky top-0">
                                    <tr>
                                        ...
                                        <th className="px-4 py-2 font-semibold text-slate-600 text-xs w-32">Källa</th>
                                        <th className="px-4 py-2 font-semibold text-slate-600 text-xs">Händelse</th>
...
// --- VY 3: EFTERFRÅGEÖVERSIKT (HUVUDVY) ---
...
const ScreenOverview = () => {
    ...
    // Härled tillstånd baserat på period
    ...
    const currentStripData = KPI_STRIP_BY_PERIOD[period]; // Använder dynamisk data
        ...
        <div className="flex flex-col h-full overflow-hidden p-6 gap-4">
            ...
            <div className="flex-1 flex flex-col min-h-0 gap-4">
                        ...
                        <div className="flex flex-row h-full"> {/* Wrapped children to ensure row layout */}
                            ...
                            <div className="w-1/4 min-w-[240px] border-r border-slate-100 p-6 flex flex-col justify-center bg-slate-50/30">
                                ...
                                <div className="text-xs text-slate-400 leading-relaxed">
                                    Prognosen inkluderar <strong>{currentSuggestions.length}</strong> aktiva AI-justeringar baserade på {period === 'day' ? 'väder och bokningar' : period === 'week' ? 'historiska trender' : 'säsongsvariationer'}.
                                </div>
                            </div>
                                        ...
                                        {viewMode === 'curve' ? (
                                            <ComposedChart data={[...chartData]} margin={{ top: 10, right: 30, left: 10, bottom: 0 }}>
                                                ...
                                                {activeStreams.includes('visitors') && (
                                                    <Line yAxisId="right" type="monotone" dataKey="visitors" name="Besökare" stroke="#10b981" strokeWidth={2} dot={false} opacity={0.6} />
                                                )}
                                                {activeStreams.includes('sales') && (
                                                    <Line yAxisId="right" type="monotone" dataKey="sales" name="Försäljning" stroke="#f59e0b" strokeWidth={2} dot={false} opacity={0.6} />
                                                )}
                                            </ComposedChart>
                                        ) : (
                ...
                <div className="shrink-0 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    {currentStripData.map((kpi, idx) => { // Uppdaterad för att använda dynamisk data
                        const Icon = kpi.icon;
                ...
                {/* ZON 3 & 4: NEDRE DELNING (AI-Förslag & Dataströmmar) */}
                            ...
                            {currentSuggestions.map(s => (
                                <div key={s.id} className="p-3 bg-white border border-slate-100 rounded-lg shadow-sm hover:border-indigo-200 hover:shadow-md transition-all group">
                                    <div className="flex justify-between items-start mb-1">
                                        <div className="flex items-center gap-2">
                                            <Badge color={s.type === 'ökning' ? 'red' : 'green'}>{s.type === 'ökning' ? 'Ökning' : 'Minskning'}</Badge>
                                    ...
                                    <div className="flex justify-between items-end">
                                        ...
                                        <div className="flex gap-2 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <button className="text-[10px] font-bold text-indigo-600 hover:text-indigo-800 bg-indigo-50 hover:bg-indigo-100 uppercase tracking-wider px-3 py-1 rounded">Godkänn</button>
                                        </div>
                                    </div>
                                </div>
                            ))}
    ...
    <div className="p-6 h-full flex flex-col gap-6">
        <div className="grid grid-cols-4 gap-4">
            ...
            <Card className="p-4 flex flex-row justify-between items-center">
                ...
                <div className="text-xs font-bold text-indigo-600 bg-indigo-50 px-2 py-1 rounded">Överbemannad</div>
            </Card>
        </div>
                    ...
                    <div className="flex flex-col h-full justify-center items-center text-center p-4">
                        ...
                        <div className="flex gap-4 w-full">
                            <button className="flex-1 p-4 border border-slate-200 rounded-xl hover:bg-rose-50 hover:border-rose-200 group transition-all">
                                ...
                                <span className="text-xs font-bold text-slate-500 group-hover:text-rose-700">För Låg</span>
                            </button>
                            ...
                            <button className="flex-1 p-4 border border-slate-200 rounded-xl hover:bg-amber-50 hover:border-amber-200 group transition-all">
                                ...
                                <span className="text-xs font-bold text-slate-500 group-hover:text-amber-700">För Hög</span>
                            </button>
                        </div>
                    </div>
                </Card>
            ...
            <div className="bg-white border-b border-slate-200 px-6 pt-4">
                ...
                <div className="flex gap-6">
                    ...
                    <button
                        ...
                        className={`pb-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'rules' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-800'}`}
                    >
                        Regelbyggare
                    </button>
                    <button
                        onClick={() => setActiveTab('monitor')}
                        className={`pb-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'monitor' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-800'}`}
                    >
                        Dataströmmar
                    </button>
                    <button
                        onClick={() => setActiveTab('feedback')}
                        className={`pb-3 text-sm font-medium border-b-2 transition-colors ${activeTab === 'feedback' ? 'border-indigo-600 text-indigo-600' : 'border-transparent text-slate-500 hover:text-slate-800'}`}
                    >
                        Feedback
                    </button>
                </div>
